...
from jax_common import MjxEnv

class SawyerNutAssemblyEnvV2(MjxEnv):
    ...
    def __init__(self, tasks=None, render_mode=None):
        ...
        self._random_reset_space = Box(
            onp.hstack((onp.asarray(obj_low), onp.asarray(goal_low))),
            onp.hstack((onp.asarray(obj_high), onp.asarray(goal_high))),
        )

        self.goal_space = Box(onp.asarray(goal_low), onp.asarray(goal_high))
    ...
    def reset_model(self, data):
        ...
        self.sys.body_pos[
            mujoco.mj_name2id(self.sys, mujoco.mjtObj.mjOBJ_BODY, "peg")
        ] = peg_pos
        self.sys.site_pos[
            mujoco.mj_name2id(self.sys, mujoco.mjtObj.mjOBJ_SITE, "pegTop")
        ] = self._target_pos
